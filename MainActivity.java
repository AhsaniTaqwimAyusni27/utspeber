...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        Intent i;
        switch (v.getId()) {
            case R.id.d1: i = new Intent(this, k1.class); startActivity(i); break;
            case R.id.d2: i = new Intent(this, k2.class); startActivity(i); break;
            case R.id.d3: i = new Intent(this, k3.class); startActivity(i); break;
            case R.id.d4: i = new Intent(this, k4.class); startActivity(i); break;
            case R.id.d5: i = new Intent(this, k5.class); startActivity(i); break;
